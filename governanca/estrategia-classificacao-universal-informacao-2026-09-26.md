# EA-000003-000043 — Classificação Universal de Informação por Sensibilidade e Publicação
...
1. **Fase 1/3 — F-000003-000043-001 — Registro e incorporação normativa**  
   Gate: pedido e estratégia persistidos; política global referenciada; regras mínimas locais definidas.

2. **Fase 2/3 — F-000003-000043-002 — Implementação e propagação**  
   Gate: AGENTS atualizado; gate de classificação incorporado ao fluxo local.

3. **Fase 3/3 — F-000003-000043-003 — Auditoria e fechamento**  
